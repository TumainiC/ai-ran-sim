...
async def handle_get_simulation_state(websocket, simulation_engine, knowledge_router, data):
    response = WebSocketResponse(
        layer="network_layer",
...
async def handle_network_engineer_chat(websocket, simulation_engine, knowledge_router, data):
    """
...
COMMAND_HANDLERS = {
    ...
    ("intelligence_layer", "user_chat"): handle_user_chat,
