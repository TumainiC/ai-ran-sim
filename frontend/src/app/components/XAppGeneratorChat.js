...
export default function XAppGeneratorChat({
  sendMessage,
  ...
  const handleSend = () => {
    ...
    sendMessage("intelligence_layer", "xapp_generator_chat", chatHistory);
    setMessages((prev) => [
      ...prev,
      {
        role: "user",
  ...
  return (
    <div className="flex flex-col h-full flex-1">
      <div className="overflow-y-auto p-4 space-y-4 flex-1" ref={messageContainerRef}>
      ...
      <div className="p-4 border-t border-base-300 bg-base-100 flex items-center gap-2">
        ...
        <textarea
          ...
          placeholder="Ask to create/list/view/reload xApps..."
